...
class IntegrationBase
{
  public:
    ...
    {
        // 噪声矩阵为什么18*18，这里是因为中值积分，所以噪声的雅克比矩阵是对上一时刻的nak,nwk,nak+1,nwk+1,nba,nbw
    ...
    void propagate(double _dt, const Eigen::Vector3d &_acc_1, const Eigen::Vector3d &_gyr_1)
    {
        ...
        //输入：和上一帧IMU数据的时间差，上一个IMU加速度数据，上一个IMU陀螺仪数据，当前IMU加速度，当前IMU陀螺仪
        // 上一个IMU预积分平移测量值，上一个IMU预积分旋转测量值，上一个IMU预积分速度测量值
        // 上一IMUba，上一IMUbg
        // 当前IMU预积分结果值
